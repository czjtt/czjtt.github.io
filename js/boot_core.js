...
$(document).ready(function() {
    ...
    var user = 'czjtt';
    if(typeof (webURL.split(splitFlag)[1]) != undefined && webURL.split(splitFlag)[1] != null){
        user = webURL.split(splitFlag)[1].split(".")[0]
    }
...
function init(){
    ...
    $.getJSON(blogListURL, function(json) {
        for (var i = 0; i < json.length; i++) {
            ...
            var new_a = $("<h3></h3>")// add blog list elements
